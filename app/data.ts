...
export const translations = {
  "zh": {
    ...
    "termLabel": "分期期数",
    "termNote": "Deposit 已算第一期；页面显示的是接下来需要还的期数。",
    "priceRowLabel": "手机售价",
    "downRowLabel": "首付金额",
    ...
    "walkInTitle": "Walk-in 门店地址",
    "walkInCopy": "也可以直接到店咨询与申请。",
    "mapButton": "打开地图",
    "deliveryTitle": "支持全马来西亚运送服务",
    "deliveryCopy": "覆盖西马、沙巴与砂拉越，提交订单后可 WhatsApp 确认配送安排。",
  ...
  "en": {
    ...
    "termNote": "The deposit counts as the first term; the page shows only the remaining payment terms.",
    ...
    "walkInTitle": "Walk-in store addresses",
    "walkInCopy": "You can also visit our stores for consultation and application.",
    "mapButton": "Open map",
    "deliveryTitle": "Nationwide Malaysia delivery",
    "deliveryCopy": "Available for Peninsular Malaysia, Sabah, and Sarawak. Confirm delivery details by WhatsApp after submitting.",
  ...
  "ms": {
    ...
    "termNote": "Deposit dikira sebagai tempoh pertama; halaman ini hanya paparkan baki tempoh bayaran.",
    ...
    "walkInTitle": "Alamat kedai walk-in",
    "walkInCopy": "Anda juga boleh datang terus ke kedai untuk pertanyaan dan permohonan.",
    "mapButton": "Buka peta",
    "deliveryTitle": "Servis penghantaran seluruh Malaysia",
    "deliveryCopy": "Meliputi Semenanjung, Sabah dan Sarawak. Selepas hantar pesanan, sahkan penghantaran melalui WhatsApp.",
